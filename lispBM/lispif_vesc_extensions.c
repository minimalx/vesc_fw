...
static bool
compare_symbol (lbm_uint sym, lbm_uint *comp)
{
    if (*comp == 0)
    {
...
static bool
is_symbol_true_false (lbm_value v)
{
...
static lbm_value
ext_print (lbm_value *args, lbm_uint argn)
{
 ...
 */
static lbm_value
ext_puts (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN(1);
...
static lbm_value
ext_set_servo (lbm_value *args, lbm_uint argn)
{
...
static lbm_value
ext_reset_timeout (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
    timeout_reset();
...
static lbm_value
ext_get_ppm (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_get_ppm_age (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_get_vin (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_select_motor (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
...
static lbm_value
ext_get_selected_motor (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
get_or_set_float (bool set, float *val, lbm_value *lbm_val)
{
    if (set)
    {
...
static lbm_value
get_or_set_i (bool set, int *val, lbm_value *lbm_val)
{
    if (set)
    {
...
static lbm_value
get_or_set_bool (bool set, bool *val, lbm_value *lbm_val)
{
    if (set)
    {
        *val = lbm_dec_as_i32(*lbm_val);
...
static lbm_value
get_set_bms_val (bool set, lbm_value *args, lbm_uint argn)
{
...
static lbm_value
ext_get_bms_val (lbm_value *args, lbm_uint argn)
{
    return get_set_bms_val(false, args, argn);
}

static lbm_value
ext_set_bms_val (lbm_value *args, lbm_uint argn)
{
    return get_set_bms_val(true, args, argn);
}

static lbm_value
ext_send_bms_can (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
    bms_send_status_can();
...
static lbm_value
ext_set_bms_chg_allowed (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
...
static lbm_value
ext_bms_force_balance (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
...
static lbm_value
ext_bms_zero_offset (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_get_adc (lbm_value *args, lbm_uint argn)
{
...
static lbm_value
ext_override_temp_motor (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
...
static lbm_value
ext_get_adc_decoded (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_NUMBER_ALL();
...
static lbm_value
ext_systime (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_secs_since (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
...
static lbm_value
ext_set_aux (lbm_value *args, lbm_uint argn)
{
...
static void
send_app_data (unsigned char *data, unsigned int len, int interface, int can_id)
{
    int32_t  index              = 0;
...
static lbm_value
ext_send_data (lbm_value *args, lbm_uint argn)
{
...
static lbm_value
ext_recv_data (lbm_value *args, lbm_uint argn)
{
...
static lbm_value
ext_get_remote_state (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_eeprom_store_f (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(2);
    ...
    return conf_general_store_eeprom_var_custom(&v, addr) ? ENC_SYM_TRUE
                                                          : ENC_SYM_NIL;
}

static lbm_value
ext_eeprom_read_f (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
...
static lbm_value
ext_eeprom_store_i (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(2);
...
static lbm_value
ext_eeprom_read_i (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
...
static lbm_value
ext_sysinfo (lbm_value *args, lbm_uint argn)
{
    lbm_value res = ENC_SYM_EERROR;
...
static lbm_value
ext_stats (lbm_value *args, lbm_uint argn)
{
    lbm_value res = ENC_SYM_EERROR;
...
static lbm_value
ext_stats_reset (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_can_cmd (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN(2);
...
static lbm_value
ext_can_local_id (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
// App set commands
static lbm_value
ext_app_adc_detach (lbm_value *args, lbm_uint argn)
{
    if (argn == 1)
    {
...
static lbm_value
ext_app_adc_override (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(2);
...
static lbm_value
ext_app_adc_range_ok (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_app_ppm_detach (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
...
static lbm_value
ext_app_ppm_override (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
...
static lbm_value
ext_set_remote_state (lbm_value *args, lbm_uint argn)
{
...
static lbm_value
ext_app_disable_output (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
...
static lbm_value
ext_app_is_output_disabled (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_app_pas_get_rpm (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_set_current (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_NUMBER_ALL();
    timeout_reset();
...
static lbm_value
ext_set_current_rel (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_NUMBER_ALL();
    timeout_reset();
...
static lbm_value
ext_set_duty (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
    timeout_reset();
...
static lbm_value
ext_set_brake (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
    timeout_reset();
...
static lbm_value
ext_set_brake_rel (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
    timeout_reset();
...
static lbm_value
ext_set_handbrake (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
    timeout_reset();
...
static lbm_value
ext_set_handbrake_rel (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
    timeout_reset();
...
static lbm_value
ext_set_rpm (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
    timeout_reset();
...
static lbm_value
ext_set_pos (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
    timeout_reset();
...
static lbm_value
ext_foc_openloop (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(2);
    timeout_reset();
    mc_interface_set_openloop_current(lbm_dec_as_float(args[0]),
                                      lbm_dec_as_float(args[1]));
    return ENC_SYM_TRUE;
}

static lbm_value
ext_foc_beep (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(3);
    timeout_reset();
    mcpwm_foc_beep(lbm_dec_as_float(args[0]),
                   lbm_dec_as_float(args[1]),
...
static lbm_value
ext_foc_play_tone (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(3);
    timeout_reset();
    bool res = mcpwm_foc_play_tone(lbm_dec_as_float(args[0]),
                                   lbm_dec_as_float(args[1]),
                                   lbm_dec_as_float(args[2]));
...
static void
foc_play_task (void *arg)
{
    foc_play_args *fp = (foc_play_args *)arg;

    for (int i = 0; i < 10000; i++)
    {
        if (mcpwm_foc_play_audio_samples(
                fp->samples, fp->num_samp, fp->f_samp, fp->voltage))
        {
            break;
        }
        chThdSleep(1);
...
static lbm_value
ext_foc_play_samples (lbm_value *args, lbm_uint argn)
{
...
static lbm_value
ext_foc_play_stop (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static bool
check_arg_filter (lbm_value *args, lbm_uint argn, int *res)
{
    *res = 0;
    if (argn > 1)
    {
...
static lbm_value
ext_get_current (lbm_value *args, lbm_uint argn)
{
    int filter = 0;
...
static lbm_value
ext_get_current_dir (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_get_current_in (lbm_value *args, lbm_uint argn)
{
    int filter = 0;
    if (!check_arg_filter(args, argn, &filter))
    {
...
static lbm_value
ext_get_id (lbm_value *args, lbm_uint argn)
{
    int filter = 0;
    if (!check_arg_filter(args, argn, &filter))
    {
...
static lbm_value
ext_get_iq (lbm_value *args, lbm_uint argn)
{
    int filter = 0;
    if (!check_arg_filter(args, argn, &filter))
    {
...
static lbm_value
ext_get_id_set (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_get_iq_set (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_get_vd (lbm_value *args, lbm_uint argn)
{
    int filter = 0;
    if (!check_arg_filter(args, argn, &filter))
    {
...
static lbm_value
ext_get_vq (lbm_value *args, lbm_uint argn)
{
    int filter = 0;
    if (!check_arg_filter(args, argn, &filter))
    {
...
static lbm_value
ext_foc_est_lambda (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_foc_est_res (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_foc_est_ind (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_get_duty (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_get_rpm (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_get_rpm_fast (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_get_rpm_faster (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_get_pos (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_get_temp_fet (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_NUMBER_ALL();
...
static lbm_value
ext_get_temp_mot (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_get_speed (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_get_dist (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_get_dist_abs (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_get_batt (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_get_fault (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_get_ah (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_get_wh (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_get_ah_chg (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_get_wh_chg (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_setup_ah (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_setup_ah_chg (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_setup_wh (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_setup_wh_chg (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_setup_current (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_setup_current_in (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_setup_num_vescs (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_get_encoder (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_set_encoder (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
...
static lbm_value
ext_get_encoder_error_rate (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_pos_pid_now (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
    return lbm_enc_float(mc_interface_get_pid_pos_now());
...
static lbm_value
ext_pos_pid_set (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_pos_pid_error (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
    return lbm_enc_float(utils_angle_difference(
        mc_interface_get_pid_pos_set(), mc_interface_get_pid_pos_now()));
}

static lbm_value
ext_phase_motor (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_phase_encoder (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_phase_hall (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_phase_observer (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_observer_error (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_can_msg_age (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(2);
    ...
    switch (msg)
    {
        case 1: {
            can_status_msg *stat
                = comm_can_get_status_msg_id(lbm_dec_as_i32(args[0]));
            if (stat)
            {
        ...
        case 2: {
            can_status_msg_2 *stat
                = comm_can_get_status_msg_2_id(lbm_dec_as_i32(args[0]));
            if (stat)
            {
                return lbm_enc_float(UTILS_AGE_S(stat->rx_time));
            }
        ...
        case 3: {
            can_status_msg_3 *stat
                = comm_can_get_status_msg_3_id(lbm_dec_as_i32(args[0]));
            if (stat)
            {
                return lbm_enc_float(UTILS_AGE_S(stat->rx_time));
            }
        ...
        case 4: {
            can_status_msg_4 *stat
                = comm_can_get_status_msg_4_id(lbm_dec_as_i32(args[0]));
            if (stat)
            {
                return lbm_enc_float(UTILS_AGE_S(stat->rx_time));
            }
        ...
        case 5: {
            can_status_msg_5 *stat
                = comm_can_get_status_msg_5_id(lbm_dec_as_i32(args[0]));
            if (stat)
            {
                return lbm_enc_float(UTILS_AGE_S(stat->rx_time));
            }
        ...
        case 6: {
            can_status_msg_6 *stat
                = comm_can_get_status_msg_6_id(lbm_dec_as_i32(args[0]));
            if (stat)
            {
                return lbm_enc_float(UTILS_AGE_S(stat->rx_time));
            }
...
static lbm_value
ext_can_current (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_NUMBER_ALL();

    if (argn == 2)
    {
        comm_can_set_current(lbm_dec_as_i32(args[0]),
                             lbm_dec_as_float(args[1]));
    }
    else if (argn == 3)
    {
        comm_can_set_current_off_delay(lbm_dec_as_i32(args[0]),
                                       lbm_dec_as_float(args[1]),
                                       lbm_dec_as_float(args[2]));
    }
    else
...
static lbm_value
ext_can_current_rel (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_NUMBER_ALL();

    if (argn == 2)
    {
        comm_can_set_current_rel(lbm_dec_as_i32(args[0]),
                                 lbm_dec_as_float(args[1]));
    }
    else if (argn == 3)
    {
        comm_can_set_current_rel_off_delay(lbm_dec_as_i32(args[0]),
                                           lbm_dec_as_float(args[1]),
                                           lbm_dec_as_float(args[2]));
    }
    else
...
static lbm_value
ext_can_duty (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(2);
...
static lbm_value
ext_can_brake (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(2);
    comm_can_set_current_brake(lbm_dec_as_i32(args[0]),
                               lbm_dec_as_float(args[1]));
    return ENC_SYM_TRUE;
}

static lbm_value
ext_can_brake_rel (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(2);
    comm_can_set_current_brake_rel(lbm_dec_as_i32(args[0]),
                                   lbm_dec_as_float(args[1]));
    return ENC_SYM_TRUE;
}

static lbm_value
ext_can_rpm (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(2);
...
static lbm_value
ext_can_pos (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(2);
...
static lbm_value
ext_can_get_current (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
...
static lbm_value
ext_can_get_current_dir (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
    can_status_msg *stat0 = comm_can_get_status_msg_id(lbm_dec_as_i32(args[0]));
    if (stat0)
...
static lbm_value
ext_can_get_current_in (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
    can_status_msg_4 *stat4
        = comm_can_get_status_msg_4_id(lbm_dec_as_i32(args[0]));
    if (stat4)
    {
...
static lbm_value
ext_can_get_duty (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
    can_status_msg *stat0 = comm_can_get_status_msg_id(lbm_dec_as_i32(args[0]));
    if (stat0)
...
static lbm_value
ext_can_get_rpm (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
    can_status_msg *stat0 = comm_can_get_status_msg_id(lbm_dec_as_i32(args[0]));
    if (stat0)
...
static lbm_value
ext_can_get_temp_fet (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
    can_status_msg_4 *stat4
        = comm_can_get_status_msg_4_id(lbm_dec_as_i32(args[0]));
...
static lbm_value
ext_can_get_temp_motor (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
    can_status_msg_4 *stat4
        = comm_can_get_status_msg_4_id(lbm_dec_as_i32(args[0]));
...
static lbm_value
ext_can_get_speed (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
    can_status_msg *stat0 = comm_can_get_status_msg_id(lbm_dec_as_i32(args[0]));
    if (stat0)
    {
        const volatile mc_configuration *conf
            = mc_interface_get_configuration();
        const float rpm = stat0->rpm / (conf->si_motor_poles / 2.0);
        return lbm_enc_float((rpm / 60.0) * conf->si_wheel_diameter * M_PI
                             / conf->si_gear_ratio);
    }
    else
    {
...
static lbm_value
ext_can_get_dist (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
    can_status_msg_5 *stat5
        = comm_can_get_status_msg_5_id(lbm_dec_as_i32(args[0]));
    if (stat5)
    {
        const volatile mc_configuration *conf
...
static lbm_value
ext_can_get_ppm (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
    can_status_msg_6 *stat6
        = comm_can_get_status_msg_6_id(lbm_dec_as_i32(args[0]));
    if (stat6)
    {
...
static lbm_value
ext_can_get_adc (lbm_value *args, lbm_uint argn)
{
    if (argn != 1 && argn != 2)
    {
        return ENC_SYM_EERROR;
...
static lbm_value
ext_can_get_vin (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
    can_status_msg_5 *stat5
        = comm_can_get_status_msg_5_id(lbm_dec_as_i32(args[0]));
...
static lbm_value
ext_can_list_devs (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_can_scan (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
    lbm_value dev_list = ENC_SYM_NIL;
...
static lbm_value
ext_can_send (lbm_value *args, lbm_uint argn, bool is_eid)
{
...
static lbm_value
ext_can_send_sid (lbm_value *args, lbm_uint argn)
{
    return ext_can_send(args, argn, false);
}

static lbm_value
ext_can_send_eid (lbm_value *args, lbm_uint argn)
{
...
static lbm_value
ext_can_recv_sid (lbm_value *args, lbm_uint argn)
{
    if (argn > 1 || (argn == 1 && !lbm_is_number(args[0])))
    {
        lbm_set_error_reason((char *)lbm_error_str_incorrect_arg);
...
static lbm_value
ext_can_recv_eid (lbm_value *args, lbm_uint argn)
{
    if (argn > 1 || (argn == 1 && !lbm_is_number(args[0])))
    {
        lbm_set_error_reason((char *)lbm_error_str_incorrect_arg);
...
static lbm_value
ext_throttle_curve (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(4);
    return lbm_enc_float(utils_throttle_curve(lbm_dec_as_float(args[0]),
                                              lbm_dec_as_float(args[1]),
                                              lbm_dec_as_float(args[2]),
...
static lbm_value
ext_rand (lbm_value *args, lbm_uint argn)
{
    if (argn != 0 && argn != 1)
    {
        lbm_set_error_reason((char *)lbm_error_str_num_args);
...
static lbm_value
ext_rand_max (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
 ...
 */
static lbm_value
ext_bits_enc_int (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(4)
 ...
 */
static lbm_value
ext_bits_dec_int (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(3)
...
static lbm_value
ext_enable_event (lbm_value *args, lbm_uint argn)
{
    if (argn != 1 && argn != 2)
    {
        return ENC_SYM_EERROR;
 ...
 */
static lbm_value
ext_raw_adc_current (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_NUMBER_ALL();
 ...
 */
static lbm_value
ext_raw_adc_voltage (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_NUMBER_ALL();
...
static lbm_value
ext_raw_mod_alpha (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_raw_mod_beta (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_raw_mod_alpha_measured (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_raw_mod_beta_measured (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_raw_hall (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_NUMBER_ALL();
...
static lbm_value
ext_uart_start (lbm_value *args, lbm_uint argn)
{
...
static lbm_value
ext_uart_stop (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_uart_write (lbm_value *args, lbm_uint argn)
{
...
static lbm_value
ext_uart_read (lbm_value *args, lbm_uint argn)
{
    ...
    if (argn >= 5)
    {
        ...
        {
            timeout = (systime_t)(lbm_dec_as_float(args[4])
...
static i2c_bb_state i2c_cfg     = { HW_UART_RX_PORT,
                                    HW_UART_RX_PIN,
                                    HW_UART_TX_PORT,
                                    HW_UART_TX_PIN,
                                    I2C_BB_RATE_400K,
...
static lbm_value
ext_i2c_start (lbm_value *args, lbm_uint argn)
{
    if (argn > 3)
    {
        return ENC_SYM_EERROR;
...
static lbm_value
ext_i2c_tx_rx (lbm_value *args, lbm_uint argn)
{
    if (argn != 2 && argn != 3)
    {
        lbm_set_error_reason((char *)lbm_error_str_num_args);
...
static lbm_value
ext_i2c_detect_addr (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
...
static lbm_value
ext_i2c_restore (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_gpio_configure (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN(2);
...
static lbm_value
ext_gpio_write (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN(2);
...
static lbm_value
ext_gpio_read (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN(1);
...
static lbm_value
ext_conf_set (lbm_value *args, lbm_uint argn)
{
    lbm_value res = ENC_SYM_EERROR;
    ...
    const float speed_fact
        = ((mcconf->si_motor_poles / 2.0) * 60.0 * mcconf->si_gear_ratio)
...
static inline float
lim_max (float min, float max)
{
    (void)min;
    return max;
}
static inline float
lim_min (float min, float max)
{
    (void)max;
    return min;
}
...
static lbm_value
ext_conf_get (lbm_value *args, lbm_uint argn)
{
    lbm_value res = ENC_SYM_EERROR;
...
static lbm_value
ext_conf_store (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
detect_task (void *arg)
{
    ...
    int res = conf_general_detect_apply_all_foc_can(a->detect_can,
                                                    a->max_power_loss,
                                                    a->min_current_in,
                                                    a->max_current_in,
                                                    a->openloop_rpm,
...
static lbm_value
ext_conf_detect_foc (lbm_value *args, lbm_uint argn)
{
...
static lbm_value
ext_conf_set_pid_offset (lbm_value *args, lbm_uint argn)
{
    if (argn != 1 && argn != 2)
    {
        lbm_set_error_reason((char *)lbm_error_str_num_args);
    ...
    if (!lbm_is_number(args[0])
        || (argn == 2 && !is_symbol_true_false(args[1])))
    {
        return ENC_SYM_TERROR;
    }
...
static lbm_value
ext_conf_measure_res (lbm_value *args, lbm_uint argn)
{
    if (argn != 1 && argn != 2)
    {
        lbm_set_error_reason((char *)lbm_error_str_num_args);
...
static void
measure_inductance_task (void *arg)
{
    int restart_cnt = lispif_get_restart_cnt();
    ...
    {
        mc_interface_select_motor_thread(a->motor);
        fault = mcpwm_foc_measure_inductance_current(a->current,
                                                     a->samples,
                                                     &real_measurement_current,
                                                     &ld_lq_diff,
                                                     &ld_lq_avg);
        mc_interface_select_motor_thread(1);
...
static lbm_value
ext_conf_measure_ind (lbm_value *args, lbm_uint argn)
{
    // measure inductance of motor @ current
    // arg0: measurement current
    // arg1: sample number. optional
    // returns: ({ld_lq_avg} {ld_lq_diff} {actual_measurement_current}) or
    // (fault-code)
    if (argn != 1 && argn != 2)
    {
        lbm_set_error_reason((char *)lbm_error_str_num_args);
...
static lbm_value
ext_conf_restore_mc (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
    ...
    mc_configuration *mcconf = mempools_alloc_mcconf();
    confgenerator_set_defaults_mcconf(mcconf);
    volatile const mc_configuration *mcconf_now
        = mc_interface_get_configuration();
...
static lbm_value
ext_conf_restore_app (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
    ...
    app_set_configuration(appconf);
    timeout_configure(appconf->timeout_msec,
                      appconf->timeout_brake_current,
...
static lbm_value
ext_conf_dc_cal (lbm_value *args, lbm_uint argn)
{
    if (argn != 1)
    {
        lbm_set_error_reason((char *)lbm_error_str_num_args);
    ...
    {
        volatile const mc_configuration *conf
            = mc_interface_get_configuration();
        lbm_value res = ENC_SYM_NIL;
        res = lbm_cons(lbm_enc_float(conf->foc_offsets_voltage_undriven[2]),
                       res);
        res = lbm_cons(lbm_enc_float(conf->foc_offsets_voltage_undriven[1]),
                       res);
        res = lbm_cons(lbm_enc_float(conf->foc_offsets_voltage_undriven[0]),
                       res);
...
static lbm_value
ext_conf_get_limits (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_me_defun (lbm_value *argsi, lbm_uint argn)
{
    if (argn != 3)
    {
        return ENC_SYM_TERROR;
    ...
    return make_list(3,
                     ...
                     name,
                     make_list(3, lbm_enc_sym(SYM_LAMBDA), args, body));
}

static lbm_value
ext_me_defunret (lbm_value *argsi, lbm_uint argn)
{
    if (argn != 3)
    {
        return ENC_SYM_EERROR;
...
static lbm_value
ext_me_loopfor (lbm_value *args, lbm_uint argn)
{
    if (argn != 5)
    {
        return ENC_SYM_EERROR;
    ...
    // (let ((loop (lambda (it res break) (if cond (loop update body break)
    // res)))) (call-cc (lambda (brk) (loop start nil brk))))
...
static lbm_value
ext_me_loopwhile (lbm_value *args, lbm_uint argn)
{
    if (argn != 2)
    {
        return ENC_SYM_EERROR;
...
static lbm_value
ext_me_looprange (lbm_value *args, lbm_uint argn)
{
    if (argn != 4)
    {
        return ENC_SYM_EERROR;
    ...
    // (let ((loop (lambda (it res break) (if (< it end) (loop (+ it 1) body
    // break) res)))) (call-cc (lambda (brk) (loop start nil brk))))
        ...
        make_list(
            ...
            make_list(
                ...
                make_list(
                    ...
                    lbm_enc_sym(SYM_LAMBDA),
                    make_list(
                        3, it, lbm_enc_sym(sym_res), lbm_enc_sym(sym_break)),
                    make_list(4,
                              lbm_enc_sym(SYM_IF),
...
static lbm_value
ext_me_loopforeach (lbm_value *args, lbm_uint argn)
{
    if (argn != 3)
    {
        return ENC_SYM_EERROR;
    ...
    // (let ((loop (lambda (it rst res break) (if (eq it nil) res (loop (car
    // rst) (cdr rst) body break))))) (call-cc (lambda (brk) (loop (car lst)
    // (cdr lst) nil brk))))
                ...
                make_list(
                    ...
                    make_list(
                        ...
                        make_list(
                            ...
                            lbm_enc_sym(sym_loop),
                            make_list(
                                2, lbm_enc_sym(SYM_CAR), lbm_enc_sym(sym_rst)),
                            make_list(
                                2, lbm_enc_sym(SYM_CDR), lbm_enc_sym(sym_rst)),
                            body,
                            lbm_enc_sym(sym_break)))))),
        make_list(2,
                  lbm_enc_sym(SYM_CALLCC),
...
static lbm_value
ext_uavcan_last_rawcmd (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
...
static lbm_value
ext_uavcan_last_rpmcmd (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
    int             can_if   = lbm_dec_as_i32(args[0]);
...
static lbm_value
ext_lbm_set_quota (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
...
lbm_value
ext_lbm_set_gc_stack_size (lbm_value *args, lbm_uint argn)
{
    if (argn == 1)
    {
        if (lbm_is_number(args[0]))
...
static lbm_value
ext_plot_init (lbm_value *args, lbm_uint argn)
{
    if (argn != 2)
    {
        return ENC_SYM_EERROR;
...
static lbm_value
ext_plot_add_graph (lbm_value *args, lbm_uint argn)
{
    if (argn != 1)
    {
        return ENC_SYM_EERROR;
...
static lbm_value
ext_plot_set_graph (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
...
static lbm_value
ext_plot_send_points (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(2);
    commands_send_plot_points(lbm_dec_as_float(args[0]),
                              lbm_dec_as_float(args[1]));
    return ENC_SYM_TRUE;
}
...
// IO-boards
static lbm_value
ext_ioboard_get_adc (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(2);
...
static lbm_value
ext_ioboard_get_digital (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(2);
...
static lbm_value
ext_ioboard_set_digital (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(3);
    int  id      = lbm_dec_as_i32(args[0]);
    int  channel = lbm_dec_as_i32(args[1]);
...
static lbm_value
ext_ioboard_set_pwm (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(3);
    int   id      = lbm_dec_as_i32(args[0]);
    int   channel = lbm_dec_as_i32(args[1]);
...
// Logging
static lbm_value
ext_log_start (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN(5);

    if (!lbm_is_number(args[0]) || !lbm_is_number(args[1])
        || !lbm_is_number(args[2]) || !is_symbol_true_false(args[3])
        || !is_symbol_true_false(args[4]))
    {
        return ENC_SYM_EERROR;
    }

    log_start(lbm_dec_as_i32(args[0]),
...
static lbm_value
ext_log_stop (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(1);
...
static lbm_value
ext_log_config_field (lbm_value *args, lbm_uint argn)
{
    if (argn != 8)
    {
        lbm_set_error_reason((char *)lbm_error_str_num_args);
...
static lbm_value
log_send_fxx (bool is_64, lbm_value *args, lbm_uint argn)
{
        ...
        if (lbm_is_number(args[arg_now]))
        {
            if (is_64)
            {
                buffer_append_float64_auto(
                    buffer, lbm_dec_as_double(args[arg_now]), &ind);
            }
            else
            {
                buffer_append_float32_auto(
                    buffer, lbm_dec_as_float(args[arg_now]), &ind);
            }
            append_cnt++;
        ...
        else if (lbm_is_cons(args[arg_now]))
        {
            ...
            while (lbm_is_cons(curr))
            {
                ...
                if (lbm_is_number(val))
                {
                    ...
                    {
                        buffer_append_float64_auto(
                            buffer, lbm_dec_as_double(val), &ind);
                    }
                    else
                    {
                        buffer_append_float32_auto(
                            buffer, lbm_dec_as_float(val), &ind);
                    }
                    append_cnt++;
                    if (append_cnt >= append_max)
                    {
...
static lbm_value
ext_log_send_f32 (lbm_value *args, lbm_uint argn)
{
    return log_send_fxx(false, args, argn);
}

static lbm_value
ext_log_send_f64 (lbm_value *args, lbm_uint argn)
{
    return log_send_fxx(true, args, argn);
}

static lbm_value
ext_gnss_lat_lon (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_gnss_height (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_gnss_speed (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_gnss_hdop (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_gnss_date_time (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_gnss_age (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_empty (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
    return ENC_SYM_TRUE;
...
static ICUConfig icucfg
    = { ICU_INPUT_ACTIVE_HIGH, 1000000, icuwidthcb, icuperiodcb, NULL,
        HW_ICU_CHANNEL,        0 };

static lbm_value
ext_icu_start (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(2);
    servodec_stop();
    pwm_servo_stop();
    ...
    icucfg.mode      = lbm_dec_as_i32(args[1]) ? ICU_INPUT_ACTIVE_HIGH
...
static lbm_value
ext_icu_width (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_icu_period (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
...
static lbm_value
ext_crc16 (lbm_value *args, lbm_uint argn)
{
...
static lbm_value
ext_crc32 (lbm_value *args, lbm_uint argn)
{
    ...
    return lbm_enc_u32(
        crc32_with_init((uint8_t *)array->data, len, lbm_dec_as_u32(args[1])));
}
 ...
 */
static lbm_value
ext_buf_resize (lbm_value *args, lbm_uint argn)
{
    ...
    if (!delta_size_passed && !new_size_passed)
    {
        lbm_set_error_reason(
            "delta-size (arg 2) was nil while new-size wasn't provided (arg "
            "3)");
        return ENC_SYM_EERROR;
    }
    ...
    else
    {
        ...
        else if (new_size < header->size)
        {
            ...
            // We sadly can't trust the return value, as it fails if the
            // allocation was previously a single word long. So we just throw it
            // away.
...
static lbm_value
ext_shutdown_hold (lbm_value *args, lbm_uint argn)
{
    if (argn != 1)
    {
        lbm_set_error_reason((char *)lbm_error_str_num_args);
...
static lbm_value
ext_canmsg_recv (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_ARGN_NUMBER(2);
...
static lbm_value
ext_canmsg_send (lbm_value *args, lbm_uint argn)
{
...
static lbm_value
ext_pwm_start (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_NUMBER_ALL();
...
static lbm_value
ext_pwm_stop (lbm_value *args, lbm_uint argn)
{
    (void)args;
    (void)argn;
    pwm_servo_stop();
...
static lbm_value
ext_pwm_set_duty (lbm_value *args, lbm_uint argn)
{
    LBM_CHECK_NUMBER_ALL();
...
void
lispif_load_vesc_extensions (void)
{
    lispif_stop_lib();
    ...
    if (event_tp == NULL)
    {
        ...
        chThdCreateStatic(event_thread_wa,
                          sizeof(event_thread_wa),
                          NORMALPRIO - 2,
                          event_thread,
                          NULL);
    }
...
static bool
start_flatten_with_gc (lbm_flat_value_t *v, size_t buffer_size)
{
...
void
lispif_process_can (uint32_t can_id, uint8_t *data8, int len, bool is_ext)
{
    if (is_ext)
    {
...
void
lispif_process_custom_app_data (unsigned char *data, unsigned int len)
{
...
void
lispif_process_rmsg (int slot, unsigned char *data, unsigned int len)
{
    if (event_tp == NULL)
    {
        return;
...
void
lispif_disable_all_events (void)
{
    if (event_tp != NULL)
    {
        chMtxLock(&rmsg_mutex);
...
// Note: This function is only safe to use from LBM extensions or while the
// evaluator is paused
bool
lispif_symbol_to_io (lbm_uint sym, stm32_gpio_t **port, uint32_t *pin)
{
