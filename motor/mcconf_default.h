...
#define MCCONF_L_IN_CURRENT_MAP_START \
    1.0 // Input current to Q axis current limit map start
#endif
#ifndef MCCONF_L_IN_CURRENT_MAP_FILTER
#define MCCONF_L_IN_CURRENT_MAP_FILTER \
    0.005 // Input current filter for the mapped limit
#endif
...
#define MCCONF_L_MIN_VOLTAGE 37.0 // Minimum input voltage
#endif
#ifndef MCCONF_L_MAX_VOLTAGE
#define MCCONF_L_MAX_VOLTAGE 57.0 // Maximum input voltage
#endif
#ifndef MCCONF_L_BATTERY_CUT_START
#define MCCONF_L_BATTERY_CUT_START \
    39.0 // Start limiting the positive current at this voltage
#endif
#ifndef MCCONF_L_BATTERY_CUT_END
#define MCCONF_L_BATTERY_CUT_END \
    38.0 // Limit the positive current completely at this voltage
#endif
#ifndef MCCONF_L_BATTERY_REGEN_CUT_START
#define MCCONF_L_BATTERY_REGEN_CUT_START \
    54.0 // Start limiting the regen current at this voltage
#endif
#ifndef MCCONF_L_BATTERY_REGEN_CUT_END
#define MCCONF_L_BATTERY_REGEN_CUT_END \
    55.0 // Limit the regen current completely at this voltage
#endif
#ifndef MCCONF_L_RPM_MAX
#define MCCONF_L_RPM_MAX 20000.0 // The motor speed limit (Upper)
#endif
#ifndef MCCONF_L_RPM_MIN
#define MCCONF_L_RPM_MIN -20000.0 // The motor speed limit (Lower)
#endif
#ifndef MCCONF_L_RPM_START
#define MCCONF_L_RPM_START \
    0.8 // Fraction of full speed where RPM current limiting starts
#endif
#ifndef MCCONF_L_SLOW_ABS_OVERCURRENT
#define MCCONF_L_SLOW_ABS_OVERCURRENT \
    false // Use the filtered (and hence slower) current for the overcurrent
          // fault detection
#endif
...
#define MCCONF_L_CURR_MAX_RPM_FBRAKE \
    300 // Maximum electrical RPM to use full brake at
#endif
...
#define MCCONF_L_LIM_TEMP_FET_START \
    85.0 // MOSFET temperature where current limiting should begin
#endif
#ifndef MCCONF_L_LIM_TEMP_FET_END
#define MCCONF_L_LIM_TEMP_FET_END \
    100.0 // MOSFET temperature where everything should be shut off
#endif
#ifndef MCCONF_L_LIM_TEMP_MOTOR_START
#define MCCONF_L_LIM_TEMP_MOTOR_START \
    85.0 // MOTOR temperature where current limiting should begin
#endif
#ifndef MCCONF_L_LIM_TEMP_MOTOR_END
#define MCCONF_L_LIM_TEMP_MOTOR_END \
    100.0 // MOTOR temperature where everything should be shut off
#endif
...
#define MCCONF_P_PID_GAIN_DEC_ANGLE \
    0.0 // Decrease PID-gains when the error is below this value
#endif
...
#define MCCONF_CC_STARTUP_BOOST_DUTY \
    0.01 // The lowest duty cycle to use in current control mode (has to be >
...
#define MCCONF_SL_MIN_ERPM_CYCLE_INT_LIMIT \
    1100.0 // Minimum RPM to calculate the BEMF coupling from
#endif
...
#define MCCONF_SL_BEMF_COUPLING_K \
    600.0 // Input voltage to bemf coupling constant
#endif
...
#define MCCONF_SL_CYCLE_INT_BR \
    80000.0 // RPM border between the START and LOW interval
#endif
#ifndef MCCONF_SL_MAX_FB_CURR_DIR_CHANGE
#define MCCONF_SL_MAX_FB_CURR_DIR_CHANGE \
    10.0 // Maximum current during full brake during which a direction change is
         // allowed
#endif
...
#define MCCONF_HALL_ERPM \
    2000.0 // ERPM above which sensorless commutation is used in hybrid mode
#endif
...
#define MCCONF_FOC_OBSERVER_GAIN_SLOW \
    0.05 // Observer gain scale at minimum duty cycle
#endif
#ifndef MCCONF_FOC_OBSERVER_OFFSET
#define MCCONF_FOC_OBSERVER_OFFSET \
    -1.0 // Observer offset in timer update cycles
#endif
#ifndef MCCONF_FOC_DUTY_DOWNRAMP_KP
#define MCCONF_FOC_DUTY_DOWNRAMP_KP \
    50.0 // PI controller for duty control when decreasing the duty
#endif
#ifndef MCCONF_FOC_DUTY_DOWNRAMP_KI
#define MCCONF_FOC_DUTY_DOWNRAMP_KI \
    1000.0 // PI controller for duty control when decreasing the duty
#endif
#ifndef MCCONF_FOC_START_CURR_DEC
#define MCCONF_FOC_START_CURR_DEC \
    1.0 // Decrease current to this fraction at start
#endif
#ifndef MCCONF_FOC_START_CURR_DEC_RPM
#define MCCONF_FOC_START_CURR_DEC_RPM \
    2500.0 // At this RPM the full current is available
#endif
...
#define MCCONF_FOC_OPENLOOP_RPM_LOW \
    0.0 // Fraction of OPENLOOP_RPM at minimum motor current
#endif
...
#define MCCONF_FOC_D_GAIN_SCALE_MAX_MOD \
    0.2 // D axis currnet controller gain at maximum modulation
#endif
#ifndef MCCONF_FOC_SL_OPENLOOP_HYST
#define MCCONF_FOC_SL_OPENLOOP_HYST \
    0.1 // Time below min RPM to activate openloop (s)
#endif
#ifndef MCCONF_FOC_SL_OPENLOOP_TIME
#define MCCONF_FOC_SL_OPENLOOP_TIME \
    0.05 // Time to remain in openloop after ramping (s)
#endif
#ifndef MCCONF_FOC_SL_OPENLOOP_BOOST_Q
#define MCCONF_FOC_SL_OPENLOOP_BOOST_Q \
    0.0 // Q-axis current boost during the open loop procedure
#endif
#ifndef MCCONF_FOC_SL_OPENLOOP_MAX_Q
#define MCCONF_FOC_SL_OPENLOOP_MAX_Q \
    -1.0 // Q-axis maximum current during the open loop procedure
#endif
#ifndef MCCONF_FOC_SL_OPENLOOP_T_LOCK
#define MCCONF_FOC_SL_OPENLOOP_T_LOCK \
    0.0 // Time to lock motor in beginning of open loop sequence
#endif
#ifndef MCCONF_FOC_SL_OPENLOOP_T_RAMP
#define MCCONF_FOC_SL_OPENLOOP_T_RAMP \
    0.1 // Time to ramp up motor to openloop speed
#endif
...
#define MCCONF_FOC_HALL_INTERP_ERPM \
    500 // Do not interpolate hall sensors below this ERPM
#endif
#ifndef MCCONF_FOC_SL_ERPM_START
#define MCCONF_FOC_SL_ERPM_START \
    2500.0 // ERPM below which only sensored commutation is used
#endif
...
#define MCCONF_FOC_SAT_COMP_MODE \
    SAT_COMP_DISABLED // Stator saturation compensation mode
#endif
...
#define MCCONF_FOC_TEMP_COMP_BASE_TEMP \
    25.0 // Motor temperature compensation base temperature
#endif
#ifndef MCCONF_FOC_CURRENT_FILTER_CONST
#define MCCONF_FOC_CURRENT_FILTER_CONST \
    0.1 // Filter constant for the filtered currents
#endif
#ifndef MCCONF_FOC_CC_DECOUPLING
#define MCCONF_FOC_CC_DECOUPLING \
    FOC_CC_DECOUPLING_DISABLED // Current controller decoupling
#endif
#ifndef MCCONF_FOC_OBSERVER_TYPE
#define MCCONF_FOC_OBSERVER_TYPE \
    FOC_OBSERVER_MXLEMMING_LAMBDA_COMP // Position observer type for FOC
#endif
#ifndef MCCONF_FOC_HFI_AMB_MODE
#define MCCONF_FOC_HFI_AMB_MODE \
    FOC_AMB_MODE_SIX_VECTOR // HFI ambiguity resolution mode
#endif
...
#define MCCONF_FOC_HFI_VOLTAGE_START \
    20 // HFI voltage at start when resolving ambiguity
#endif
...
#define MCCONF_FOC_HFI_VOLTAGE_MAX \
    6 // HFI voltage during tracking at max current
#endif
#ifndef MCCONF_FOC_SL_ERPM_HFI
#define MCCONF_FOC_SL_ERPM_HFI \
    3000.0 // ERPM above which only the observer is used
#endif
#ifndef MCCONF_FOC_HFI_START_SAMPLES
#define MCCONF_FOC_HFI_START_SAMPLES \
    5 // Sample this often at start to resolve ambiguity
#endif
...
#define MCCONF_FOC_HFI_SAMPLES \
    HFI_SAMPLES_16 // Samples per motor revolution for HFI
#endif
...
#define MCCONF_FOC_PHASE_FILTER_ENABLE \
    true // Use phase voltage filters when available
#endif
#ifndef MCCONF_FOC_PHASE_FILTER_DISABLE_FAULT
#define MCCONF_FOC_PHASE_FILTER_DISABLE_FAULT \
    true // Disable phase filter fault code
#endif
#ifndef MCCONF_FOC_PHASE_FILTER_MAX_ERPM
#define MCCONF_FOC_PHASE_FILTER_MAX_ERPM \
    4000.0 // Use phase filter up to this ERPM
#endif
#ifndef MCCONF_FOC_MTPA_MODE
#define MCCONF_FOC_MTPA_MODE \
    MTPA_MODE_OFF // Maximum torque per amp (MTPA) algorithm mode
#endif
...
#define MCCONF_FOC_FW_DUTY_START \
    0.9 // Start field weakening at this fraction of max duty cycle
#endif
...
#define MCCONF_FOC_FW_Q_CURRENT_FACTOR \
    0.02 // Factor of the FW-current to feed to the Q-axis to slow motor down
         // when setting 0 current
#endif
#ifndef MCCONF_FOC_SPEED_SOURCE
#define MCCONF_FOC_SPEED_SOURCE \
    FOC_SPEED_SRC_CORRECTED // Position source for speed trackers
#endif
#ifndef MCCONF_FOC_SHORT_LS_ON_ZERO_DUTY
#define MCCONF_FOC_SHORT_LS_ON_ZERO_DUTY \
    false // Short low-side phases on zero duty cycle
#endif
...
#define MCCONF_GPD_BUFFER_NOTIFY_LEFT \
    200 // Notify when the buffer space left is less than this
#endif
...
#define MCCONF_M_FAULT_STOP_TIME \
    500 // Ignore commands for this duration in msec when faults occur
#endif
#ifndef MCCONF_M_RAMP_STEP
#define MCCONF_M_RAMP_STEP \
    0.02 // Duty cycle ramping step (1000 times/sec) at maximum duty cycle
#endif
#ifndef MCCONF_M_CURRENT_BACKOFF_GAIN
#define MCCONF_M_CURRENT_BACKOFF_GAIN \
    0.5 // The error gain of the current limiting algorithm
#endif
...
#define MCCONF_M_ENCODER_SINCOS_FILTER \
    0.5 // Sin/Cos Encoder signal filter constant
#endif
#ifndef MCCONF_M_ENCODER_SINCOS_PHASE
#define MCCONF_M_ENCODER_SINCOS_PHASE \
    0.0 // Sin/Cos Encoder signal phase correction
#endif
#ifndef MCCONF_M_SENSOR_PORT_MODE
#define MCCONF_M_SENSOR_PORT_MODE \
    SENSOR_PORT_MODE_HALL // The mode of the hall_encoder port
#endif
...
#define MCCONF_M_DRV8301_OC_MODE \
    DRV8301_OC_LIMIT // DRV8301 over current protection mode
#endif
...
#define MCCONF_M_MOTOR_TEMP_SENS_TYPE \
    TEMP_SENSOR_NTC_10K_25C // Motor temperature sensor type
#endif
...
#define MCCONF_M_HALL_EXTRA_SAMPLES \
    3 // Extra samples for filtering when reading hall sensors
#endif
